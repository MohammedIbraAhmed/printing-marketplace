...
const signUpSchema = z.object({
  ...
  role: z.enum(['customer', 'creator', 'printShop']).refine((val) => val !== undefined, {
...
export function SignUpForm() {
  ...
  // const router = useRouter() // Will be used for navigation after registration
                ...
                <FormItem>
                  ...
                  {passwordValidation && password.length > 0 && (
                    <div className="text-xs space-y-1">
                      <div className={`${passwordValidation.strength === 'weak' ? 'text-red-500' : 
                                       passwordValidation.strength === 'medium' ? 'text-yellow-500' :
                                       passwordValidation.strength === 'strong' ? 'text-blue-500' : 'text-green-500'}`}>
